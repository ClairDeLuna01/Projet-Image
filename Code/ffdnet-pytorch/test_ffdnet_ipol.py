...
def test_ffdnet(**args):
    ...
    try:
        rgb_den = is_rgb(args['input'], not args["quiet"])
    except:
    ...
    if rgb_den:
        in_ch = 3
        model_fn = args['model_fn'] if args['model_fn'] else 'models/net_rgb.pth'
        ...
        in_ch = 1
        model_fn = args['model_fn'] if args['model_fn'] else 'models/net_gray.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="ffdnet.png",
                        help='path to output image')
    parser.add_argument("--quiet", action='store_true',
                        help='do not print messages to std-out')
